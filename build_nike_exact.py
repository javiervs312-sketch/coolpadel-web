...
<body class="bg-[#0b1626] text-slate-100 min-h-screen relative selection:bg-cool-orange selection:text-white overflow-x-hidden">
  ...
  <header class="sticky top-0 z-40 bg-white text-slate-900 border-b border-slate-200 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      ...
      <!-- LOGO CENTRADO: MASCOTA + LETRAS COOLPADEL -->
  ...
  <!-- 3. HERO SLIDER ESTILO NIKE ULTRA ELEGANTE -->
  <section class="relative bg-black overflow-hidden select-none">
    ...
    <div id="slider-container" class="relative w-full overflow-hidden">
      ...
      <div id="slider-track" class="slider-track">
        ...
        <!-- SLIDE 1: LLAVEROS PARA TU CLUB/COMUNIDAD (FOTO GANAR LA RED) -->
        <div class="slide-item relative h-[560px] sm:h-[660px] lg:h-[720px] cursor-pointer" onclick="document.querySelector('#llaveros').scrollIntoView({behavior: 'smooth'})">
          <!-- Foto de las palas azules Ganar la Red en pista -->
          <img src="assets/images/llaveros-padel-azul.png" alt="Llaveros pala de pádel Ganar la Red" class="w-full h-full object-cover">
          
          <!-- Nike Subtle Cinematic Overlays -->
          ...
          <!-- Slide Content: Nike Exact Minimalist Layout -->
        ...
        <div class="slide-item relative h-[560px] sm:h-[660px] lg:h-[720px] cursor-pointer" onclick="document.querySelector('#savemyplay').scrollIntoView({behavior: 'smooth'})">
          <img src="assets/images/background-fair.jpg" alt="Save my Play cámaras inteligentes de pádel" class="w-full h-full object-cover filter brightness-80">
          <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/30 to-transparent"></div>
          <div class="absolute inset-0 bg-gradient-to-r from-black/75 via-black/20 to-transparent"></div>
        ...
        <div class="slide-item relative h-[560px] sm:h-[660px] lg:h-[720px] cursor-pointer" onclick="document.querySelector('#informe').scrollIntoView({behavior: 'smooth'})">
          <img src="assets/images/coolpadel-hd-banner.jpg" alt="Informe de la industria del pádel" class="w-full h-full object-cover filter contrast-110 brightness-75">
      ...
      <!-- CONTROLES ESTILO NIKE (PAUSA + FLECHAS REDONDAS ABAJO A LA DERECHA) -->
  ...
  <script>
    ...
    with open(out_file, "w", encoding="utf-8") as f:
        f.write(html)
    print("Nike exact slider layout generated successfully.")

if __name__ == "__main__":
    build_nike_exact_site()
