...
<body class="bg-[#0b1626] text-slate-100 min-h-screen relative selection:bg-cool-orange selection:text-white overflow-x-hidden">
  ...
  <!-- 3. HERO SLIDER ESTILO NIKE CON LAS FOTOS BUENAS -->
  <section class="relative bg-black overflow-hidden select-none">
    ...
    <div id="slider-container" class="relative w-full overflow-hidden">
      ...
      <div id="slider-track" class="slider-track">
        ...
        <!-- SLIDE 1: FOTO GANAR LA RED (1920x1080 HD) -->
        <div class="slide-item relative h-[560px] sm:h-[660px] lg:h-[720px] cursor-pointer" onclick="document.querySelector('#llaveros').scrollIntoView({behavior: 'smooth'})">
          <img src="assets/images/ganar-la-red-hd.jpg" alt="Llaveros pala de pádel Ganar la Red HD" class="w-full h-full object-cover">
          ...
          <!-- Slide Content -->
          <div class="absolute bottom-12 sm:bottom-16 left-6 sm:left-12 lg:left-20 max-w-xl space-y-4">
            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-black font-heading text-white uppercase tracking-tight leading-[1.15]">
              Llaveros para tu <br class="hidden sm:inline">
              <span class="line-through decoration-cool-orange decoration-[3px] text-neutral-400">club</span> 
              <span class="text-white ml-1.5">comunidad</span>
            </h1>
            
            <div class="pt-2">
              <a href="#llaveros" class="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-white text-black font-heading font-black text-xs sm:text-sm hover:bg-neutral-200 transition shadow-xl">
                Ver Llaveros
              </a>
            </div>
          </div>
        ...
        <!-- SLIDE 2: SAVE MY PLAY (HD) -->
        <div class="slide-item relative h-[560px] sm:h-[660px] lg:h-[720px] cursor-pointer" onclick="document.querySelector('#savemyplay').scrollIntoView({behavior: 'smooth'})">
          <img src="assets/images/gallery-padel-1.png" alt="Save my Play cámaras inteligentes de pádel" class="w-full h-full object-cover filter brightness-85">
          <div class="absolute inset-0 bg-gradient-to-t from-black/95 via-black/30 to-transparent"></div>
          <div class="absolute inset-0 bg-gradient-to-r from-black/75 via-black/20 to-transparent"></div>

          <div class="absolute bottom-12 sm:bottom-16 left-6 sm:left-12 lg:left-20 max-w-xl space-y-4">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-black font-heading text-white uppercase tracking-tight leading-[1.15]">
              Save my Play: <br>
              <span class="text-emerald-400">Cámaras con IA</span>
            </h2>

            <div class="pt-2">
              <a href="#savemyplay" class="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-white text-black font-heading font-black text-xs sm:text-sm hover:bg-neutral-200 transition shadow-xl">
                Descubrir
              </a>
            </div>
          </div>
        ...
        <!-- SLIDE 3: BLOG & INFORME DEL NEGOCIO DEL PÁDEL (HD) -->
        <div class="slide-item relative h-[560px] sm:h-[660px] lg:h-[720px] cursor-pointer" onclick="document.querySelector('#informe').scrollIntoView({behavior: 'smooth'})">
          <img src="assets/images/gallery-padel-2.png" alt="Informe de la industria del pádel" class="w-full h-full object-cover filter contrast-110 brightness-75">
          ...
          <div class="absolute bottom-12 sm:bottom-16 left-6 sm:left-12 lg:left-20 max-w-xl space-y-4">
            ...
            <div class="pt-2">
              <a href="#informe" class="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-white text-black font-heading font-black text-xs sm:text-sm hover:bg-neutral-200 transition shadow-xl">
                Descargar PDF
              </a>
            </div>
          </div>
      ...
      <div class="absolute bottom-8 right-6 sm:right-12 z-30 flex items-center gap-2">
        <button id="pause-slide-btn" class="w-9 h-9 rounded-full bg-neutral-900/80 hover:bg-neutral-800 text-white flex items-center justify-center border border-neutral-700/80 backdrop-blur-sm transition" title="Pausar / Reproducir">
          <i id="pause-icon" data-lucide="pause" class="w-4 h-4"></i>
        </button>
        <button id="prev-slide-btn" class="w-9 h-9 rounded-full bg-neutral-900/80 hover:bg-neutral-800 text-white flex items-center justify-center border border-neutral-700/80 backdrop-blur-sm transition" title="Anterior">
          <i data-lucide="chevron-left" class="w-4 h-4"></i>
        </button>
        <button id="next-slide-btn" class="w-9 h-9 rounded-full bg-neutral-900/80 hover:bg-neutral-800 text-white flex items-center justify-center border border-neutral-700/80 backdrop-blur-sm transition" title="Siguiente">
      ...
      <div class="grid sm:grid-cols-3 gap-6 mb-16">
        ...
        <div class="glass-card-clean rounded-2xl p-4 group transition duration-300 hover:-translate-y-1">
          <div class="aspect-[4/3] rounded-xl overflow-hidden mb-3 bg-slate-900">
            <img src="assets/images/ganar-la-red-hd.jpg" alt="Llaveros de pádel para clubs" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
          </div>
        ...
        <div class="glass-card-clean rounded-2xl p-4 group transition duration-300 hover:-translate-y-1">
          <div class="aspect-[4/3] rounded-xl overflow-hidden mb-3 bg-slate-900">
            <img src="assets/images/gallery-padel-1.png" alt="Llavero Custom Pádel" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
          </div>
        ...
        <div class="glass-card-clean rounded-2xl p-4 group transition duration-300 hover:-translate-y-1">
          <div class="aspect-[4/3] rounded-xl overflow-hidden mb-3 bg-slate-900">
            <img src="assets/images/gallery-padel-2.png" alt="Llaveros de raqueta" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
          </div>
  ...
  <script>
    ...
    with open(out_file, "w", encoding="utf-8") as f:
        f.write(html)
    print("Clean HD index.html generated successfully.")
