...
<body class="bg-[#0b1626] text-slate-100 min-h-screen relative selection:bg-cool-orange selection:text-white overflow-x-hidden">
  ...
  <!-- 3. HERO SLIDER ESTILO NIKE: FOTOS TAL CUAL SIN TRANSPARENCIAS NI TRANSLÚCIDOS -->
  <section class="relative bg-[#07111e] overflow-hidden select-none py-4 sm:py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      
      <div id="slider-container" class="relative w-full rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl bg-neutral-900 border border-slate-800">
        
        <!-- Slider Track -->
        <div id="slider-track" class="slider-track">
          
          <!-- SLIDE 1: FOTO 1 LLAVEROS TAL CUAL -->
          <div class="slide-item relative h-[420px] sm:h-[500px] lg:h-[560px] cursor-pointer bg-neutral-950 flex items-center justify-center overflow-hidden" onclick="document.querySelector('#llaveros').scrollIntoView({behavior: 'smooth'})">
            <!-- Imagen 100% pura y limpia sin filtros ni transparencias -->
            <img src="assets/images/slide-1.png" alt="Llaveros CoolPadel" class="w-full h-full object-cover">
            
            <!-- Texto y botón limpios en la esquina inferior izquierda -->
            <div class="absolute bottom-8 left-6 sm:left-10 z-20 space-y-3">
              <h1 class="text-2xl sm:text-4xl lg:text-5xl font-black font-heading text-white uppercase tracking-tight drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">
          ...
          <!-- SLIDE 2: FOTO 2 SAVE MY PLAY TAL CUAL -->
          <div class="slide-item relative h-[420px] sm:h-[500px] lg:h-[560px] cursor-pointer bg-neutral-950 flex items-center justify-center overflow-hidden" onclick="document.querySelector('#savemyplay').scrollIntoView({behavior: 'smooth'})">
            <!-- Imagen 100% pura y limpia -->
            <img src="assets/images/slide-2.png" alt="Save my Play cámaras inteligentes de pádel" class="w-full h-full object-cover">

            <div class="absolute bottom-8 left-6 sm:left-10 z-20 space-y-3">
              <h2 class="text-2xl sm:text-4xl lg:text-5xl font-black font-heading text-white uppercase tracking-tight drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">
                Save my Play: <br>
          ...
          <!-- SLIDE 3: FOTO 3 INFORME / PDF TAL CUAL -->
          <div class="slide-item relative h-[420px] sm:h-[500px] lg:h-[560px] cursor-pointer bg-neutral-950 flex items-center justify-center overflow-hidden" onclick="document.querySelector('#informe').scrollIntoView({behavior: 'smooth'})">
            <!-- Imagen 100% pura y limpia -->
  ...
  <script>
    ...
    with open(out_file, "w", encoding="utf-8") as f:
        f.write(html)
    print("Site updated with natural, non-translucent photos and balanced size!")

if __name__ == "__main__":
    build_natural_slides_site()
