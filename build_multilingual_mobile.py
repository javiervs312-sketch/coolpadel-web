...
<body class="bg-[#0b1626] text-slate-100 min-h-screen relative selection:bg-cool-orange selection:text-white overflow-x-hidden w-full">
  ...
  <section id="contacto" class="py-14 sm:py-20 bg-[#3478a6] relative border-t border-sky-700/40 text-white overflow-hidden">
    <div class="max-w-[1550px] mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
      ...
      <!-- 3 BLOQUES GRANDES, SEPARADOS Y PERFECTAMENTE SIMÉTRICOS -->
      <div class="grid grid-cols-1 md:grid-cols-[1.1fr_auto_1.1fr] items-center gap-8 md:gap-8 lg:gap-14 w-full max-w-[1400px] mx-auto">
        
        <!-- IZQUIERDA: COOLPADEL (MASCOTA + TIPOGRAFÍA) -->
        <div class="flex items-center justify-center md:justify-end gap-3 sm:gap-4.5 px-2">
          <img src="{asset_prefix}assets/images/coolpadel-mascot-hd.png" alt="CoolPadel Mascota" class="h-14 sm:h-18 lg:h-20 w-auto object-contain drop-shadow-md" loading="lazy">
          <img src="{asset_prefix}assets/images/coolpadel-typography-hd.png" alt="CoolPadel" class="h-7 sm:h-9 lg:h-10 w-auto object-contain drop-shadow-md" loading="lazy">
        </div>

        <!-- CENTRO: CORREO Y WHATSAPP OFICIAL DE JAVIER -->
        <div class="flex flex-col items-center justify-center text-center gap-4 sm:gap-5 px-4 lg:px-8 shrink-0">
          <a href="mailto:javier@coolpadelstudios.com" 
             class="group inline-flex items-center gap-2.5 text-white hover:text-[#f2920b] font-sans font-bold text-base sm:text-xl lg:text-2xl tracking-normal transition-all duration-300 hover:scale-105 active:scale-95">
            <i data-lucide="mail" class="w-5 h-5 sm:w-6 sm:h-6 text-[#f2920b] group-hover:text-white transition-colors shrink-0"></i>
        ...
        <div class="flex items-center justify-center md:justify-start px-2">
          <img src="{asset_prefix}assets/images/savemyplay-logo-white-text-hd.png" alt="Save my Play" class="h-10 sm:h-13 lg:h-15 w-auto object-contain drop-shadow-md" loading="lazy">
        </div>
