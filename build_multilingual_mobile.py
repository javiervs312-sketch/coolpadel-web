  ...
  <section id="contacto" class="py-14 sm:py-20 bg-[#3478a6] relative border-t border-sky-700/40 text-white overflow-hidden">
    <div class="max-w-[1550px] mx-auto px-6 sm:px-12 lg:px-16 relative z-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-center gap-8 md:gap-0 w-full">
        ...
        <!-- CENTRO: TÍTULO CONTACTO + CORREO Y WHATSAPP OFICIAL DE JAVIER (ALINEADOS VERTICALMENTE) -->
        <div class="flex flex-col items-center justify-center text-center gap-3 sm:gap-4 px-4 sm:px-6 md:translate-x-8 lg:translate-x-14">
          <h2 data-i18n="contact_title" class="text-2xl sm:text-4xl lg:text-5xl font-black font-heading text-white uppercase tracking-tight leading-tight mb-1 sm:mb-2">
            {t['contact_title']}
          </h2>
          ...
          <a id="contact-wa-btn" href="https://wa.me/34680317486?text={t['wa_prefilled_msg']}" 
             target="_blank" 
             class="group inline-flex items-center gap-2.5 px-6 sm:px-7 py-2.5 sm:py-3 rounded-full bg-[#25D366] hover:bg-[#20ba59] active:bg-[#20ba59] text-white font-sans font-black text-xs sm:text-sm tracking-wider uppercase shadow-md hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300 mt-1 sm:mt-2">
