  ...
  <section id="contacto" class="py-14 sm:py-20 bg-[#3478a6] relative border-t border-sky-700/40 text-white overflow-hidden">
    <div class="max-w-[1550px] mx-auto px-6 sm:px-12 lg:px-16 relative z-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-center gap-8 md:gap-0 w-full">
        ...
        <!-- IZQUIERDA: COOLPADEL (MASCOTA + TIPOGRAFÍA) MOVIDO UN PELÍN A LA DERECHA -->
        <div class="flex items-center justify-center md:justify-end gap-3 sm:gap-4 md:pr-12 lg:pr-16 xl:pr-20 md:pl-8">
        ...
        <div class="flex items-center justify-center md:justify-start md:pl-12 lg:pl-16 xl:pl-20 md:pr-8">
