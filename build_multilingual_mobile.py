...
<body class="bg-[#0b1626] text-slate-100 min-h-screen relative selection:bg-cool-orange selection:text-white overflow-x-hidden w-full">
  ...
  <section id="contacto" class="py-14 sm:py-20 bg-[#3478a6] relative border-t border-sky-700/40 text-white overflow-hidden">
    <div class="max-w-[1550px] mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
      ...
      <!-- 3 BLOQUES MATEMÁTICAMENTE SIMÉTRICOS Y BALANCEADOS -->
      <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-6 sm:gap-8 md:gap-4 w-full max-w-5xl mx-auto">
        
        <!-- IZQUIERDA: COOLPADEL (MASCOTA + TIPOGRAFÍA) -->
        <div class="flex items-center justify-center md:justify-end gap-2.5 sm:gap-3.5 px-2">
          <img src="{asset_prefix}assets/images/coolpadel-mascot-hd.png" alt="CoolPadel Mascota" class="h-10 sm:h-12 lg:h-14 w-auto object-contain drop-shadow-md" loading="lazy">
          <img src="{asset_prefix}assets/images/coolpadel-typography-hd.png" alt="CoolPadel" class="h-5 sm:h-6.5 lg:h-7.5 w-auto object-contain drop-shadow-md" loading="lazy">
        </div>

        <!-- CENTRO: CORREO Y WHATSAPP OFICIAL DE JAVIER -->
        <div class="flex flex-col items-center justify-center text-center gap-3 sm:gap-4 px-2">
          <a href="mailto:javier@coolpadelstudios.com" 
             class="group inline-flex items-center gap-2 text-white hover:text-[#f2920b] font-sans font-bold text-sm sm:text-base lg:text-lg tracking-normal transition-all duration-300 hover:scale-105 active:scale-95">
            <i data-lucide="mail" class="w-4 h-4 sm:w-5 sm:h-5 text-[#f2920b] group-hover:text-white transition-colors shrink-0"></i>
            <span class="underline decoration-white/40 group-hover:decoration-[#f2920b] underline-offset-4">javier@coolpadelstudios.com</span>
          </a>

          <!-- BOTÓN WHATSAPP OFICIAL EN CONTACTO -->
          <a id="contact-wa-btn" href="https://wa.me/34680317486?text={t['wa_prefilled_msg']}" 
             target="_blank" 
             class="group inline-flex items-center gap-2 px-5 sm:px-6 py-2 sm:py-2.5 rounded-full bg-[#25D366] hover:bg-[#20ba59] active:bg-[#20ba59] text-white font-sans font-black text-xs sm:text-sm tracking-wider uppercase shadow-md hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300">
        ...
        <div class="flex items-center justify-center md:justify-start px-2">
          <img src="{asset_prefix}assets/images/savemyplay-logo-white-text-hd.png" alt="Save my Play" class="h-7 sm:h-9 lg:h-11 w-auto object-contain drop-shadow-md" loading="lazy">
        </div>
