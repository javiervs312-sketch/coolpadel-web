...
<body class="bg-[#0b1626] text-slate-100 min-h-screen relative selection:bg-cool-orange selection:text-white overflow-x-hidden w-full">
  ...
  <section id="contacto" class="py-14 sm:py-20 bg-[#3478a6] relative border-t border-sky-700/40 text-white overflow-hidden">
    <div class="max-w-[1550px] mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
      ...
      <!-- 3 BLOQUES INTEGRADOS, PROPORCIONADOS Y PERFECTAMENTE CENTRADOS -->
      <div class="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-14 xl:gap-20 w-full max-w-6xl mx-auto">
        
        <!-- IZQUIERDA: COOLPADEL (MASCOTA + TIPOGRAFÍA) -->
        <div class="flex items-center justify-center gap-3 sm:gap-3.5 shrink-0">
          <img src="{asset_prefix}assets/images/coolpadel-mascot-hd.png" alt="CoolPadel Mascota" class="h-12 sm:h-15 lg:h-16 w-auto object-contain drop-shadow-md" loading="lazy">
          <img src="{asset_prefix}assets/images/coolpadel-typography-hd.png" alt="CoolPadel" class="h-6 sm:h-7.5 lg:h-8.5 w-auto object-contain drop-shadow-md" loading="lazy">
        </div>
        ...
        <div class="flex items-center justify-center shrink-0">
          <img src="{asset_prefix}assets/images/savemyplay-logo-white-text-hd.png" alt="Save my Play" class="h-9 sm:h-11 lg:h-12 w-auto object-contain drop-shadow-md" loading="lazy">
        </div>
