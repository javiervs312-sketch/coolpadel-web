...
<body class="bg-[#0b1626] text-slate-100 min-h-screen relative selection:bg-cool-orange selection:text-white overflow-x-hidden">
  ...
  <header class="sticky top-0 z-40 bg-white text-slate-900 border-b border-slate-200 shadow-sm">
    <div class="w-full max-w-[1700px] mx-auto px-3 sm:px-6 lg:px-12 h-18 sm:h-22 lg:h-24 flex items-center justify-between gap-2 sm:gap-4">
      ...
      <!-- DERECHA: SELECTOR DE IDIOMAS + BOTÓN CONTACTAR EN EL CENTRO EXACTO + OJOS A LA DERECHA -->
      <div class="flex items-center flex-1 min-w-0">
        <div class="flex-1 flex items-center justify-center gap-1.5 sm:gap-3 lg:gap-4">
          
          <!-- SELECTOR DE IDIOMA INTERACTIVO COMPACTO -->
          <div class="inline-flex items-center bg-slate-100 rounded-full p-0.5 sm:p-1 border border-slate-200/90 shadow-inner text-[10px] sm:text-xs font-bold shrink-0" id="lang-switcher">
