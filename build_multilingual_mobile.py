        ...
        <div class="flex items-center justify-end min-w-0 h-full gap-2 sm:gap-3 lg:gap-5">
          ...
          <div class="relative inline-block text-left" id="lang-dropdown-container">
            ...
            <div id="lang-dropdown-menu" class="hidden absolute right-0 mt-2 w-24 bg-white rounded-2xl shadow-[0_12px_30px_rgba(0,0,0,0.15)] border border-slate-200 py-1.5 z-50 transition-all overflow-hidden">
              <button type="button" onclick="switchLanguage('es')" data-lang-opt="es" class="lang-opt {'bg-[#f2920b] text-slate-950 font-black' if active_lang=='es' else 'text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold'} w-full text-center px-4 py-2 text-xs transition duration-150 cursor-pointer">
                ES
              </button>
              <button type="button" onclick="switchLanguage('en')" data-lang-opt="en" class="lang-opt {'bg-[#f2920b] text-slate-950 font-black' if active_lang=='en' else 'text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold'} w-full text-center px-4 py-2 text-xs transition duration-150 cursor-pointer">
                EN
              </button>
              <button type="button" onclick="switchLanguage('fr')" data-lang-opt="fr" class="lang-opt {'bg-[#f2920b] text-slate-950 font-black' if active_lang=='fr' else 'text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold'} w-full text-center px-4 py-2 text-xs transition duration-150 cursor-pointer">
                FR
              </button>
              <button type="button" onclick="switchLanguage('it')" data-lang-opt="it" class="lang-opt {'bg-[#f2920b] text-slate-950 font-black' if active_lang=='it' else 'text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold'} w-full text-center px-4 py-2 text-xs transition duration-150 cursor-pointer">
                IT
              </button>
            </div>
          </div>
          ...
          <div class="flex items-center gap-1.5 shrink-0">
            ...
            <div class="relative inline-block text-left" id="lang-dropdown-container-mob">
              ...
              <div id="lang-dropdown-menu-mob" class="hidden absolute right-0 mt-1 w-20 bg-white rounded-2xl shadow-xl border border-slate-200 py-1 z-50 transition-all overflow-hidden">
                <button type="button" onclick="switchLanguage('es')" data-lang-opt="es" class="lang-opt {'bg-[#f2920b] text-slate-950 font-black' if active_lang=='es' else 'text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold'} w-full text-center px-3 py-1.5 text-[11px] transition duration-150 cursor-pointer">
                  ES
                </button>
                <button type="button" onclick="switchLanguage('en')" data-lang-opt="en" class="lang-opt {'bg-[#f2920b] text-slate-950 font-black' if active_lang=='en' else 'text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold'} w-full text-center px-3 py-1.5 text-[11px] transition duration-150 cursor-pointer">
                  EN
                </button>
                <button type="button" onclick="switchLanguage('fr')" data-lang-opt="fr" class="lang-opt {'bg-[#f2920b] text-slate-950 font-black' if active_lang=='fr' else 'text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold'} w-full text-center px-3 py-1.5 text-[11px] transition duration-150 cursor-pointer">
                  FR
                </button>
                <button type="button" onclick="switchLanguage('it')" data-lang-opt="it" class="lang-opt {'bg-[#f2920b] text-slate-950 font-black' if active_lang=='it' else 'text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold'} w-full text-center px-3 py-1.5 text-[11px] transition duration-150 cursor-pointer">
                  IT
                </button>
              </div>
            </div>
  ...
  <script>
    ...
    function switchLanguage(lang) {{
      ...
      document.querySelectorAll('[data-lang-opt]').forEach(btn => {{
        ...
        if (optLang === lang) {{
          btn.className = 'lang-opt bg-[#f2920b] text-slate-950 font-black w-full text-center px-4 py-2 text-xs transition duration-150 cursor-pointer';
          if (btn.closest('#lang-dropdown-menu-mob')) {{
            btn.className = 'lang-opt bg-[#f2920b] text-slate-950 font-black w-full text-center px-3 py-1.5 text-[11px] transition duration-150 cursor-pointer';
          }}
        }} else {{
          btn.className = 'lang-opt text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold w-full text-center px-4 py-2 text-xs transition duration-150 cursor-pointer';
          if (btn.closest('#lang-dropdown-menu-mob')) {{
            btn.className = 'lang-opt text-slate-700 hover:bg-[#f2920b] hover:text-slate-950 font-bold w-full text-center px-3 py-1.5 text-[11px] transition duration-150 cursor-pointer';
          }}
        }}
      }});
