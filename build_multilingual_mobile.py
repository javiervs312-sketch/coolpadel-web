...
<body class="bg-[#0b1626] text-slate-100 min-h-screen relative selection:bg-cool-orange selection:text-white overflow-x-hidden w-full">
  ...
  <!-- 8. SECCIÓN CONTACTO (FONDO CELESTE #3478a6 & ALTURA EQUILIBRADA) -->
  <section id="contacto" class="py-12 sm:py-16 lg:py-20 bg-[#3478a6] relative border-t border-sky-700/40 text-white overflow-hidden">
