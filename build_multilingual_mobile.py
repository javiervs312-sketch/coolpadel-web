...
<body class="bg-[#0b1626] text-slate-100 min-h-screen relative selection:bg-cool-orange selection:text-white overflow-x-hidden">
  ...
  <header class="sticky top-0 z-40 bg-white text-slate-900 border-b border-slate-200 shadow-sm">
    <div class="w-full max-w-[1700px] mx-auto px-3 sm:px-6 lg:px-12 py-2 sm:py-0 h-auto sm:h-22 lg:h-24 flex flex-col sm:flex-row items-center justify-between gap-1.5 sm:gap-4">
      
      <!-- FILA PRINCIPAL: OJOS (IZQ) + MASCOTA & TYPOGRAPHY (CENTRO) + IDIOMAS / OJOS (DCHA) -->
      <div class="w-full flex items-center justify-between sm:justify-start sm:flex-1 min-w-0">
        <!-- IZQUIERDA: OJOS A LA IZQUIERDA + TENIS Y PADEL EN DESKTOP -->
        ...
        <!-- CENTRO: MASCOTA + LETRAS COOLPADEL -->
        <div class="flex items-center justify-center flex-shrink-0 mx-auto sm:mx-0 sm:flex-1">
          <a href="#" class="flex items-center justify-center gap-2 sm:gap-3.5 group py-1 sm:py-2">
            <img src="{asset_prefix}assets/images/coolpadel-mascot-hd.png" alt="Mascota CoolPadel" class="h-8 sm:h-13 lg:h-16 w-auto object-contain group-hover:scale-105 transition max-h-[64px]">
            <img src="{asset_prefix}assets/images/coolpadel-typography-hd.png" alt="CoolPadel" class="h-5 sm:h-8 lg:h-11 w-auto object-contain">
          </a>
        </div>

        <!-- DERECHA (MÓVIL): SELECTOR DE IDIOMAS COMPACTO -->
        <div class="flex sm:hidden items-center shrink-0">
          <div class="inline-flex items-center bg-slate-100 rounded-full p-0.5 border border-slate-200/90 shadow-inner text-[10px] font-bold shrink-0">
      ...
      <!-- DERECHA EN DESKTOP: SELECTOR DE IDIOMAS + BOTÓN CONTACTAR + OJOS -->
      <div class="hidden sm:flex items-center flex-1 justify-end gap-3 lg:gap-4 min-w-0">
      ...
      <!-- FILA 2 EN MÓVIL: BOTÓN CONTACTAR COMPACTO -->
      <div class="w-full flex sm:hidden items-center justify-center pb-1">
